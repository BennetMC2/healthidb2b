import type { EvidenceTier, FusionDef, SignalCategory, SignalDef, SignalId, TrustTier } from "@shared/schema";
...
export function signalsForCategory(category: SignalCategory): SignalDef[] {
...
export function evidenceGateMultiplier(evidenceTier: EvidenceTier): number {
