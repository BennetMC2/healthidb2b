...
export const industryContexts: Record<PartnerIndustry, IndustryContext> = {
  insurance: {
    ...
    costOfInaction: 'The average healthcare data breach costs $10.93M',
    costSource: 'IBM Cost of a Data Breach Report, 2023',
  ...
  healthcare: {
    ...
    costOfInaction: 'Healthcare has led all industries in breach costs for 13 consecutive years',
    costSource: 'IBM Cost of a Data Breach Report, 2023',
